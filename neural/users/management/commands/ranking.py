...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for user_data in all_user_training:
            ...
            print(f"User {user} updated with {index} position and {user_data.get('training_count', 0)} trainings")
            index += 1
